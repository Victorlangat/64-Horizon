    ...
    <div className='about-us'>
      <div className='aboutusimage'>
        <div className='aboutusoverlay'>
          <h2>About Us</h2>
          <p>We are a team of movie enthusiasts who have created this app to make the process of booking movie tickets easier and more. We hope you enjoy using our app as much as we enjoyed creating it!</p>
        </div>
      </div>
    </div>
  );
